$(document).ready(function () {
    ...
    function UpdateData(data1, data2) {
        ...
        data1.forEach(function (item) {
            ...
            var productAnhSanPham = $('<div class="AnhSanPham"></div>');
            var productImg = $('<img class="anh1" src="/' + item["ảnh sản phẩm"] + '">');
            var productImg2 = $('<img class="anh2" src="tieu-de-tang-vest.png">');
            ...
            productAnhSanPham.append(productImg, productImg2)
            productContent.append(productName, productIcon);
            productDiv.append(productAnhSanPham, productContent, productPrice, mauSacDiv);
    ...
    function LoadDataBoLoc() {
        ...
        $.ajax({
            url: 'Vest', // Đường dẫn API để lấy dữ liệu
            method: 'GET',
            dataType: 'json',
            success: function (data) {
    ...
    function click_yeuthich() {
        ...
        //     </div>
        //     <div class="close-yeuthich"><i class="fas fa-times"></i></div>
        // </div>
