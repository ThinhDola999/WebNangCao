...
const Data = async (req, res) => {
    try {
        ...
        let AoQuanData = [...dataQuan];

        const LoaiDataForm = LocDuLieuTheoForm(AoQuanData, "loại quần");
        const LoaiDataThietKe = LocDuLieuTheoThietKe(AoQuanData, "loại quần");
        ...
        // const Data = [...dataAo, ...dataQuan];

        LoaiData = sapxep(sortOrderBody, LoaiData);


        const LoaiDataBoLoc = filterUniqueProducts(AoQuanData, "loại quần")
        // LoaiData = [...dulieuSacXep];
